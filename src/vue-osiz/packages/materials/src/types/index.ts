...
/** Slider config */
interface AdminLayoutSliderConfig {
  /**
   * Whether slider is visible
   *
   * @default true
   */
  ...
  /**
   * Slider collapse status
   *
   * @default false
   */
  sliderCollapse?: boolean;
  /**
   * Slider width when collapse is false
   *
   * @default '220px'
   */
  sliderWidth?: number;
  /**
   * Slider width when collapse is true
   *
   * @default '64px'
   */
...
export interface AdminLayoutProps
   ...
   *
   * The z-index of Header,Tab,Slider and Footer will not exceed this value
   */
  maxZIndex?: number;
}
...
export type LayoutCssVarsProps = Pick<
  AdminLayoutProps,
  'headerHeight' | 'tabHeight' | 'sliderWidth' | 'sliderCollapsedWidth' | 'footerHeight'
> & {
  headerZIndex?: number;
  tabZIndex?: number;
  sliderZIndex?: number;
  mobileSliderZIndex?: number;
  footerZIndex?: number;
};
